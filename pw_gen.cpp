...
#define white_on_black SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),FOREGROUND_INTENSITY | \
        FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE);
#define red_on_black SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),FOREGROUND_INTENSITY | \
        FOREGROUND_RED);
